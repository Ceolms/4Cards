...
public class SoundPlayer : MonoBehaviour
{
    ...
    public void Play(string name)
    {
        ...
        if(s == null) s = System.Array.Find(randomCardSound, sound => sound.name.Equals(name, System.StringComparison.InvariantCultureIgnoreCase));
        if (s != null)
        {
    ...
    {
        int r = Random.Range(0, randomCardSound.Length);
        Play(randomCardSound[r].name);
    }
